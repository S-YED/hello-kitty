...
output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_syed_moinuddin_14_arn" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.arn
  sensitive = false
}


output "aws_cloudwatch_log_group_aws_lambda_hello_kitty_function_syed_moinuddin_14_name" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.name
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_syed_moinuddin_14_arn" {
  value = module.appcd_b71fd16c-797e-5a95-8e1b-ab22f1e34f43.arn
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_syed_moinuddin_14_name" {
